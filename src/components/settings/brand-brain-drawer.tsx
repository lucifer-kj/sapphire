...
export const BrandBrainDrawer: React.FC<BrandBrainDrawerProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-black/70 backdrop-blur-sm transition-opacity animate-in fade-in duration-200">
      <div className="w-full max-w-lg bg-zinc-950 h-full shadow-2xl flex flex-col border-l border-white/10 text-zinc-100">
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-6">
          ...
          <div className="p-4 rounded-2xl bg-zinc-900 border border-white/5 space-y-2 shadow-sm">
            <div className="flex items-center justify-between">
              <span className="font-semibold text-zinc-100 text-text-sm">{brand.name}</span>
              <span className="text-[10px] text-emerald-400 font-medium bg-emerald-950/40 px-2.5 py-0.5 rounded-full border border-emerald-800/40">
            ...
            <div className="flex items-center gap-2 pt-1 border-t border-white/5 text-[11px] text-zinc-400">
              <span className="font-medium text-zinc-200">Industry:</span>
          ...
          <div className="p-4 rounded-2xl bg-zinc-900 border border-white/5 space-y-2.5 shadow-sm">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Zap className="w-4 h-4 text-emerald-400" />
                <h3 className="font-semibold text-text-xs uppercase tracking-wider text-zinc-200">
            ...
            <div className="space-y-1.5 font-mono text-[11px]">
              ...
              <div className="flex items-center justify-between text-[10px] text-zinc-500 font-sans pt-1">
                ...
                <span className="text-emerald-400 font-medium">Free Tier Active</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between border-b border-white/5 pb-2">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-semibold text-text-xs uppercase tracking-wider text-zinc-400">
                  Visual Archetype Win Rates
                </h3>
              </div>
              <span className="text-[11px] text-emerald-400 font-medium">Bayesian Updated</span>
            </div>
            ...
            <div className="space-y-3 pt-1">
              {[
                ...
                return (
                  <div key={key} className="space-y-1.5 p-3 rounded-2xl bg-zinc-900 border border-white/5">
                    ...
                    <input
                      ...
                      className="w-full h-1.5 bg-zinc-800 rounded-lg appearance-none cursor-pointer accent-sapphire-terracotta"
                    />
                  </div>
                );
              })}
              ...
              {[
                ...
                <button
                  ...
                  className={`p-3 rounded-2xl border text-left transition-all ${
                    temperature === t.id
                      ? "bg-zinc-850 border-sapphire-terracotta ring-1 ring-sapphire-terracotta/40"
                      : "bg-zinc-900 border-white/5 hover:border-white/15 text-zinc-400"
                  }`}
                >
                  <p className="text-text-xs font-semibold text-zinc-200">{t.label}</p>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-3 gap-2 pt-1">
              {[
                ...
                >
                  <p className="text-text-xs font-semibold text-zinc-200">{d.label}</p>
          ...
          <div className="space-y-2 p-3.5 rounded-2xl bg-zinc-900 border border-white/5 shadow-sm">
            <div className="flex items-center gap-2 text-text-xs font-semibold text-zinc-200">
        ...
        <div className="p-4 bg-zinc-900 border-t border-white/5 flex items-center justify-between">
          <button
            type="button"
            onClick={onClose}
            className="px-3.5 py-2 rounded-xl border border-white/10 text-text-xs font-medium hover:bg-zinc-800 text-zinc-300 transition-colors"
          >
            Cancel
          </button>
          <button
